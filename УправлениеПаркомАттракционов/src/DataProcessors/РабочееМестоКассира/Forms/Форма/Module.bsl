...
Процедура СоздатьДекорацииИзбранныхТоваров()
	...
	Для Сч = 1 По КоличествоИзбранныхТоваров Цикл
		...
		Декорация.УстановитьДействие("Нажатие", "Подключаемый_ДекорацияИзИзбранныхТовароыНажатие");
		
		СтрокаОписанияДеорации = ДинамическиеЭлементы.Добавить();
		СтрокаОписанияДеорации.ИмяЭлемента = ИмяДекорации;
...
// Подключаемый декорация из избранных товароы нажатие.
// 
// Параметры:
//  Элемент - ДекорацияФормы
&НаКлиенте
Процедура Подключаемый_ДекорацияИзИзбранныхТовароыНажатие(Элемент)
